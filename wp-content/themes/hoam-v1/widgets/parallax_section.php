<?php // Adds widget: Parallax Section
class Parallaxsection_Widget extends WP_Widget {

	function __construct() {
		parent::__construct(
			'parallaxsection_widget',
			esc_html__( 'Parallax Section', 'textdomain' ),
			array( 'description' => esc_html__( 'Add an image with parallax scrolling effect.', 'textdomain' ), ) // Args
		);
...
function register_parallaxsection_widget() {
	register_widget( 'Parallaxsection_Widget' );
}
add_action( 'widgets_init', 'register_parallaxsection_widget' );